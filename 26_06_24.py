...
# ----------------------------------------------------------------------------------
# with XDMFFile(mesh.comm, "./26_06_24/fem_function_modulo_E_0.xdmf", "w") as file:
#           file.write_mesh(mesh)
#           file.write_function(fem_function_modulo_E_f ,0.0)


# with XDMFFile(mesh.comm, "./26_06_24/fem_function_densidad_0.xdmf", "w") as file:
#           file.write_mesh(mesh)
...
#            array_modulo_E_f[condicion_cortical]= 84370 * (array_BVTV[condicion_cortical] ** 2.58) * (array_alpha ** 2.74) *1e3
    ...
    with XDMFFile(mesh.comm, "./26_06_24/fase_6/fem_function_dot_tbr.xdmf", "w") as file_dot_tbr, \
         ...
         XDMFFile(mesh.comm, "./26_06_24/fase_6/fem_function_array_psi_reference.xdmf", "w") as file_array_psi_reference, \
